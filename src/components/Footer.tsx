        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-primary-foreground/70">
              <li><a href="#uslugi" className="hover:text-gold transition-colors">Akty notarialne</a></li>
              <li><a href="#uslugi" className="hover:text-gold transition-colors">Umowy notarialne nieruchomości</a></li>
              <li><a href="#uslugi" className="hover:text-gold transition-colors">Testamenty</a></li>
              <li><a href="#uslugi" className="hover:text-gold transition-colors">Obsługa spółek</a></li>
              <li><a href="#uslugi" className="hover:text-gold transition-colors">Prawo spadkowe i rodzinne</a></li>
            </ul>
          </div>
        </div>
